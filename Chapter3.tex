...
\textbf{Longest Common Substring (LCS)}, compares documents in pairs. This is the algorithms chosen to be implemented in this project. It is chosen for a number of reasons. 
